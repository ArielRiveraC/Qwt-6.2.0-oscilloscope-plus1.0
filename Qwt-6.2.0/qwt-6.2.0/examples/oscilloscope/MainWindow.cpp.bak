    ...
    : QWidget( parent )
{
    ...
    m_vectorstring = new QVector<QString>(0);
...
void MainWindow::handle_Capturebutton()
{
    ...
    m_vectorstring->append(fileBase + str);
    m_plot->getplotScreenShot(fileBase + str, 800, 600);
}
...
void MainWindow::handle_ItemClicked()
{
    ...
    /*/ Debug*
    QMessageBox msgBox;
    msgBox.setText("index_vectorstring = " + QString("%1").arg(index_vectorstring));
    //msgBox.setText("index_vectorstring = ");
    msgBox.setStyleSheet("background-color: lightblue;");
    msgBox.exec();
    /*/
