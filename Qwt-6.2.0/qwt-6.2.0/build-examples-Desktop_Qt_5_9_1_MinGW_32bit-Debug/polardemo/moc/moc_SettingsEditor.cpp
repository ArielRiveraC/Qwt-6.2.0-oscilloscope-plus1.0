...
#include "../../../examples/polardemo/SettingsEditor.h"
...
void SettingsEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SettingsEditor *_t = static_cast<SettingsEditor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SettingsEditor::*_t)(const PlotSettings & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingsEditor::edited)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SettingsEditor::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_SettingsEditor.data,
      qt_meta_data_SettingsEditor,  qt_static_metacall, nullptr, nullptr}
};
