...
QT_MOC_LITERAL(5, 68, 17), // "handle_Stopbutton"
QT_MOC_LITERAL(6, 86, 20), // "handle_Capturebutton"
QT_MOC_LITERAL(7, 107, 19) // "handle_Changebutton"

    },
    "MainWindow\0amplitudeChanged\0\0"
    "frequencyChanged\0signalIntervalChanged\0"
    "handle_Stopbutton\0handle_Capturebutton\0"
    "handle_Changebutton"
};
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->handle_Stopbutton(); break;
        case 4: _t->handle_Capturebutton(); break;
        case 5: _t->handle_Changebutton(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::handle_Stopbutton)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::handle_Capturebutton)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::handle_Changebutton)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void MainWindow::handle_Changebutton()
{
