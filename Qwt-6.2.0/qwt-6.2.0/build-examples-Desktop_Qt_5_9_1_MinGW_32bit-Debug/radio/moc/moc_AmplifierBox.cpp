...
#include "../../../examples/radio/AmplifierBox.h"
...
void AmplifierBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AmplifierBox *_t = static_cast<AmplifierBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AmplifierBox::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_AmplifierBox.data,
      qt_meta_data_AmplifierBox,  qt_static_metacall, nullptr, nullptr}
};
...
void *AmplifierBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AmplifierBox.stringdata0))
        return static_cast<void*>(const_cast< AmplifierBox*>(this));
